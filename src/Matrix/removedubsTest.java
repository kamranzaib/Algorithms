...
import algoimports.LinkedListNode;

public class removedubsTest {
    ...
    public static void main(String[] args) {
        ...
        removeDoubles.deleteDups(cloneA);
        removeDoubles.deleteDups(cloneB);
        removeDoubles.deleteDups(cloneC);
